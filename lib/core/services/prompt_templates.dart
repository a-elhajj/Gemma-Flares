...
const kFramingWearableData =
    ...
    'today_date, yesterday_date, and week_start_date injected into the grounded context. '
    'STEP 1 — Identify what the user is asking:\n'
    '  • Single metric + window: "What was my HRV yesterday?" → state the number first.\n'
    '  • Multiple metrics: "What were my steps and sleep this week?" → answer each metric in turn.\n'
    '  • Comparison: "How does my HRV this month compare to last?" → state both values and the direction of change.\n'
    '  • Trend/pattern: "How has my sleep been?" → summarise the recent trend, not just one point.\n'
    'STEP 2 — State the specific number(s) in your very first sentence '
    '(e.g. "You took 8,243 steps yesterday." or "Your HRV this month averaged 54 ms, '
    'up from 48 ms last month — a 12% improvement.").\n'
    'STEP 3 — Add one sentence of plain-language context. For comparisons, state '
    'whether the change is in a favorable or less favorable direction.\n'
    'STEP 4 — If data for the requested period is missing, say so in one sentence '
    'and state the most recent date that does have data.\n'
    'UNIT CONVERSIONS (always apply):\n'
    '  • Steps: add approx miles (steps × 0.00047).\n'
    '  • Sleep: hours and minutes (e.g. "7 h 23 min").\n'
    '  • HRV SDNN: ms; note "higher = better recovery baseline".\n'
    '  • SpO2: percentage (normal ≥ 95%).\n'
    '  • HR / RHR: bpm (typical resting range 50–100).\n'
    '  • Distance: km (2 decimal places).\n'
    '  • Temperature: °C (note it is relative to personal baseline).\n'
    '  • Energy: kcal.\n'
    '  • Speed: m/s (1 decimal place).\n'
    'DEFAULT AGGREGATION: when the user does not specify "total" or "sum", '
    'report the average for the requested window.\n'
    'Do NOT interpret results as medical findings. '
    'Do NOT use bold text or markdown headers. '
    'Keep the full reply to 2–3 sentences.';
